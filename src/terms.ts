...
Service Professionals understand and agree that they are customers of TrialBase, and are not TrialBase employees, contractors, consultants, joint venturers, partners, or agents. Service Professionals acknowledge that they provide their own equipment, select their own jobs, develop their own expertise, are free to do jobs through other platforms and lead sources, and determine their own work schedule.

TrialBase does not control, and has no right to control, the services a Service Professional provides (including the details of how the Service Professional provides such services) if the Service Professional is engaged by an Attorney User or any other person, except as specifically noted herein or on the Platform.

By registering or using the Platform to offer, contract, or provide Pro Services, Service Professionals represent and warrant that they are properly and fully licensed by the appropriate government boards and authorities, as required by applicable laws or regulations to which they may be subject in the jurisdiction(s) in which they offer their Pro Services and in relation to the specific job they are performing.

Service Professionals otherwise agree to comply with all applicable laws, including the California Consumer Privacy Act, any other applicable privacy laws in their use of the Platform and any personal information obtained from the Platform.

CSR Users licensed in the State of California specifically represent and warrant that they shall comply with the requirements of California Business and Professions Code §8050(d). TrialBase verifies the good standing status of professional licenses and certifications as reported by Service Professionals and we may limit, block, suspend, deactivate, or cancel a Service Professional's account based on the results of such a verification, with or without notice.

As a Service Professional, you agree and authorize us to use your personal information, such as your full name and license number, to perform such verifications. Service Professionals agree to inform TrialBase of any material changes in their professional license status.
...
You may not modify the paper or digital copies of any materials you have printed off or downloaded in any way, and you must not use any illustrations, photographs, video or audio sequences or any graphics separately from any accompanying text. You may print off one copy and may download extracts of any pages from our Platform for your personal use and you may draw the attention of others within your organization to content posted on our Platform.
...
## Marketplace Payments; Fees; Billing; Collections
...
Notwithstanding any facilitation of booking or payment, you understand and agree that TrialBase (i) does not sell, offer, provide or subcontract any Pro Service and (ii) is not liable in any way for any Pro Service.

Notwithstanding TrialBase's role as a payment facilitator, each Service Professional who receives Marketplace Payments understands and agrees that they are obligated to perform the Pro Service as outlined in their agreement with the Attorney User and work to remedy any material deviations from such contract.
...
You agree to notify us of any changes to your account information or termination of your authorization at least five days prior to your next payment.

If your full payment is not processed by us at the same time, you hereby authorize partial debits from your bank account, not to exceed the total amount of your order. You agree to pay any ACH fees or fines you or we incur associated with transactions you authorize. This return fee will vary based on which state you are located in. The return fee may be added to your payment amount and debited from your bank account if we resubmit an ACH debit due to insufficient funds.
...
You must report any fraudulent, erroneous or unauthorized transactions to your bank no more than 60 days after the disputed transaction appeared on your bank account statement. Please contact your bank for more information about the policies and procedures that apply unauthorized transactions and the limits on your liability.

### Marketplace Payment Disputes

All requests for Marketplace Payment chargebacks, errors, claims, refunds and disputes ("Payment Disputes") will be subject to review by TrialBase in accordance with the rules applicable to the payment method you used to make the Marketplace Payment and will be in TrialBase's absolute discretion. TrialBase is not liable to you under any circumstances for Payment Disputes we are unable to resolve in your favor.

We will normally process a valid written Payment Dispute request within 30 days after we receive it, unless a shorter period is required by law. You may file a Payment Dispute by emailing it to TrialBase support at support@trialbase.com. If you close or deactivate your Account before we adjudicate your Payment Dispute, we will not be able to issue you any amounts you are owed.

We will attempt to pay you any Payment Disputed amounts you are owed using the method with which you made the disputed payment, but we cannot guarantee that we will be able to do so if your payment method information is inaccurate, incomplete, or has been canceled.
...
## Subscriptions and Automatic Renewal (If Applicable)

If TrialBase offers any subscription, free trial that converts to paid, or other automatically renewing or recurring billing arrangement for any Platform feature ("Subscription"), TrialBase will present clear and conspicuous disclosures of: (i) the amount to be charged and the charge frequency; (ii) that the Subscription will renew automatically unless canceled; and (iii) how to cancel. TrialBase will obtain your affirmative consent before charging you for a Subscription. Where required by California law, TrialBase will provide renewal and/or trial-ending reminders and will make cancellation available in a manner that is at least as easy as sign-up.
...
TrialBase values our Service Professionals and Attorney Users, and we understand that occasionally disputes may arise between or among them. Our goal is to provide tools to help Users resolve such disputes independently.

In the rare event a dispute regarding an interaction related to the Platform cannot be resolved independently, you agree, at TrialBase's request, to participate in good faith, to the extent you are reasonably able to do so, in a neutral resolution or mediation conducted by TrialBase or a neutral third-party mediator or arbitrator selected by TrialBase.

Notwithstanding the foregoing, you acknowledge and agree that TrialBase is under no obligation to become involved in or impose resolution in any dispute between or among Users or any third-party.
...
As between TrialBase, Inc., and you, TrialBase, Inc., or its licensors own and reserve all right, title and interest in and to our Platform and in the Content published on it, other than the rights explicitly granted to you to use the Services in accordance with these Terms. No title to or ownership of any proprietary rights related to the Platform or any of its Content is transferred to you pursuant to these Terms. All rights not explicitly granted to you are reserved by TrialBase, Inc.

In the event that you provide comments, suggestions and recommendations to TrialBase, Inc., with respect to the Service (including, without limitation, with respect to modifications, enhancements, improvements and other changes to the Platform or the Services) (collectively, "Feedback"), you hereby grant to TrialBase, Inc., a world-wide, royalty free, irrevocable, perpetual license to use and otherwise incorporate any Feedback in connection with the Platform or the Services.

We also have the right to disclose your identity to any third party who is claiming that any content posted or uploaded by you to our Platform constitutes a violation of their intellectual property rights, or of their right to privacy. We will not be responsible or liable to any third party for the content or accuracy of any content posted by you or any other user of our Platform. We have the right to remove any posting you make on our Site in our sole discretion.

The views expressed by other users on our Platform do not represent our views or values.

## Trademarks

TrialBase, Inc., its logo, the TrialBase, Inc. app icons, and all product names and trade names, regardless of whether they appear with capital letters or with a trademark symbol, and all products denoted with TM, SM or ® are trademarks, trade names, service marks or registered trademarks or service marks of TrialBase, Inc., its affiliated companies, or its licensors or joint venture partners.

Nothing contained on this Platform should be construed as granting any license or right to use any trademark displayed on this site without our express written permission or such third party that may own the trademark.

## Third-Party Content

The Services may contain links to third-party websites or resources. We provide these links only as a convenience and are not responsible for the content, products or services on or available from those websites or resources or links displayed on such sites. You acknowledge sole responsibility for and assume all risk arising from your use of any third-party websites or resources.

You understand that the information and opinions in the third-party content are neither endorsed by nor do they reflect the opinions or beliefs of TrialBase, Inc.

## Mobile Services

We may offer services that are available via your mobile phone, including, without limitation, the ability to upload content to the Site, blog post, and send and receive messages, instant messages, location information, data transactions and other types of communications that may be developed for the Platform (collectively "Mobile Services"). Your mobile carrier's normal messaging, data and other rates and fees may apply when using the Mobile Services.

In addition, downloading, installing, or using certain Mobile Services may be prohibited or restricted by your mobile carrier, and not all Mobile Services may work with all mobile carriers or devices.

By providing your cell number upon registering or by using any Mobile Services, you agree that we may communicate with you regarding TrialBase, Inc., the Services and the Platform and other entities, by SMS, MMS, text message, push message or other electronic means to your mobile device and that certain information about your usage of the Mobile Services may be communicated to us.

**Opt-Out:** Where TrialBase sends you recurring marketing SMS messages (if any), you may opt out by following the unsubscribe or opt-out instructions in the message (for example, replying "STOP"), subject to carrier and platform limitations.

## Disclaimers and Limitation of Liability

We do not represent or warrant that the Platform is error free or free of viruses or other harmful components, or that defects will be remedied. We make no warranty regarding the quality, accuracy, timeliness, truthfulness, completeness, or reliability of any part of the Content or Services. We do not guarantee that our Platform, or any Content on it, will always be uninterrupted, secure, or provided on an error-free basis, or operate at any particular speed.

We may suspend, withdraw, discontinue or change all or any part of our Platform without notice. We may make improvements and/or changes to features, functionality or Content on the Platform at any time. We will not be liable to you if for any reason our Platform is unavailable at any time or for any period.
...
You acknowledge that we will have the right to report to law enforcement authorities any action that may be considered illegal, as well as any reports it receives of such conduct. When requested, we will cooperate fully with law enforcement agencies in any investigation of alleged illegal activity.

## Export Control

Any software or technology obtained from TrialBase, Inc., through the Services originates in the United States, and is subject to United States export laws and regulations. Such software and technology may not be exported or re-exported to certain countries or those persons or entities prohibited from receiving exports from the United States. In addition, software and technology obtained from us may be subject to the import and export laws of other countries.

It is your responsibility to comply with all U.S. and foreign export and import laws and regulations.

## Local Laws

We control and operate the Site from within the United States and make no representation that the content, services or information is appropriate or will be available for use in other locations. Unless otherwise explicitly stated, all marketing or promotional materials found on this Platform are solely directed to individuals, companies or other entities located in the United States.

If you use this Site from outside the United States, you are entirely responsible for compliance with applicable local laws, including, but not limited to, export and import regulations.

## Government Use

If the Service is being acquired on behalf of the United States Government ("USG"), then the following provision applies: This is commercial computer software.
...
We may, in our discretion, with or without cause, with or without prior notice and at any time, limit, block, suspend, deactivate or cancel your TrialBase Account in whole or in part.
...
Most disputes can be resolved without resort to litigation. You can reach TrialBase's support department at support@trialbase.com. Except for intellectual property and small claims court claims, the parties agree to use their best efforts to settle any dispute, claim, question, or disagreement directly through consultation with the TrialBase support department, and good faith negotiations will be a condition to either party initiating a lawsuit or arbitration.

### Binding Arbitration

If the parties do not reach an agreed-upon solution within a period of thirty (30) days from the time informal dispute resolution is initiated under the Initial Dispute Resolution provision above, then either party may initiate binding arbitration as the sole means to resolve claims, subject to the terms set forth below.
...
WITHOUT LIMITING THE FOREGOING, TRIALBASE AND OUR AFFILIATES AND SUBSIDIARIES, AND RESPECTIVE OFFICERS, DIRECTORS, EMPLOYEES AND AGENTS EXPLICIT.
`,
};
